Feature: Edit Blog
  ...
  Scenario: TCC.JC.160 User Edit Foto Blog
  ...
  Scenario: TCC.JC.163 User Edit Noactive Blog
  ...
  Scenario: TCC.JC.164 User Edit Settohome Yes Blog
  ...
  Scenario: TCC.JC.165 User Edit Settohome No Blog
  ...
  Scenario: TCC.JC.166 User Edit Content Priview Blog
  ...
  Scenario: TCC.JC.167 User Edit Content Blog
